...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _previousRising=R4
	.DEF _previousRising_msb=R5
	...
	.DEF _ending_edge=R12
	.DEF _ending_edge_msb=R13
...
_0x0:
	...
	.DB  0x79,0x3A,0x20,0x0,0x25,0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2040060:
	.DB  0x1
...
; 0000 002B     currentTime = 256*ICR1H + ICR1L;
	...
	STS  _currentTime+1,R31
	STS  _currentTime+2,R22
	STS  _currentTime+3,R23
; 0000 002C     PORTC = digits[currentTime % 10];
	LDS  R26,_currentTime
	LDS  R27,_currentTime+1
	LDS  R24,_currentTime+2
	LDS  R25,_currentTime+3
	__GETD1N 0xA
	CALL __MODD21U
	LDI  R26,LOW(_digits)
